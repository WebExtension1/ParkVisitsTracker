...
<body>
    ...
    <div style="display: flex; flex-direction: row; gap: 10vw">
        <div>
            <h1 style="margin: calc(50vh - 90px) 0px 5px 45px; color: white; font-size: 50px;">Robert Jenner</h1>
            <h3 style="margin: 5px 0px 0px 65px; color: white; font-size: 29px; font-weight: normal;">19 year-old Web Developer</h3>
            <h5 style="margin: 7px 0px 0px 85px; color: white; font-size: 19px; font-weight: normal;">Studying Software Engineering at Sheffield Hallam University</h5>
        </div>
        <div>
            <h1 style="margin: calc(50vh - 160px) 0px 5px 75px; font-size: 80px;"><a href="<?php echo $directoryString; ?>portfolio/projects" style="color:lightgray;">Projects</a></h1>
            <h1 style="margin: 5px 0px 5px 135px; font-size: 80px;"><a href="<?php echo $directoryString; ?>portfolio/contact" style="color:lightgray;">Contact</a></h1>
            <h1 style="margin: 5px 0px 5px 215px; font-size: 80px;"><a href="<?php echo $directoryString; ?>portfolio/about" style="color:lightgray;">About Me</a></h1>
        </div>
    </div>
    <?php
